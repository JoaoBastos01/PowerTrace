...
HOUSE_TEMPLATES: Dict[str, TopologyTemplate] = {
    ...
    "medium": TopologyTemplate(
        ...
        optional=(("bedroom_3", 0.15), ("bathroom_2", 0.35)),
        topology={"living": ("kitchen", "corridor"), "kitchen": ("living",), "corridor": ("bathroom_1", "bedroom_1", "bedroom_2", "bedroom_3"), "bathroom_1": ("corridor",), "bedroom_1": ("corridor", "bathroom_2"), "bedroom_2": ("corridor",), "bedroom_3": ("corridor",), "bathroom_2": ("bedroom_1",)},
    ),
    "large": TopologyTemplate(
        required=("living", "kitchen", "corridor", "bathroom_1", "bedroom_1", "bedroom_2", "bedroom_3", "garage"),
        optional=(("bathroom_2", 0.7),),
        topology={"living": ("kitchen", "corridor", "garage"), "kitchen": ("living",), "corridor": ("bathroom_1", "bedroom_1", "bedroom_2", "bedroom_3"), "bathroom_1": ("corridor",), "bedroom_1": ("corridor", "bathroom_2"), "bedroom_2": ("corridor",), "bedroom_3": ("corridor",), "bathroom_2": ("bedroom_1",), "garage": ("living",)},
    ),
}
